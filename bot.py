...
SPAWN_EVERY = 20  # Change to 3 for testing
BID_DURATION = 60
BID_EXTEND = 10
TRADE_TIMEOUT = 120
USER_MSG_COOLDOWN = 5
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # SPAWN COUNTER FOR GROUP CHATS (FIXED)
    if update.effective_chat.type in ("group", "supergroup"):
        ...
        # Count ALL messages, not just unique ones
...
async def main():
    ...
    logging.info(f"✅ Spawn every {SPAWN_EVERY} messages")
