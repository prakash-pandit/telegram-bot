...
# ✅ FIXED: Removed async from Flask route — Flask doesn't support it
@flask_app.route('/webhook', methods=['POST'])
def webhook():
    if request.is_json:
        update = Update.de_json(request.get_json(), application.bot)
        # ✅ Schedule coroutine on the bot's event loop safely
...
async def main():
    ...
    # ✅ Capture the running event loop for use in Flask thread
